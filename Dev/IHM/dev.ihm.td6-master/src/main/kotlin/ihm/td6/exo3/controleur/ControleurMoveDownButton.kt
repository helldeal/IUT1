...
class ControleurMoveDownButton(vue: VueTodos, modele: Todos): EventHandler<ActionEvent> {
    ...
    override fun handle(p0: ActionEvent?) {
        if (vue.myListView.selectionModel.selectedIndex!=vue.myListView.items.size-1){
